...
@section('content')
    ...
    <script>
        $(document).ready(function () {
            $('#laporan_pekerjaan_swakelola-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{{ route('report.laporan-pekerjaan-swakelola.data') }}',
                    data: function (d) {
            ...
            $('#filter').on('click', function () {
                $('#laporan_pekerjaan_swakelola-table').DataTable().ajax.reload();
            });
            ...
            $('#export-btn').on('click', function(e) {
                ...
                let url = '{{ route("report.laporan-pekerjaan-swakelola.export") }}' + '?start_date=' + start + '&end_date=' + end;
