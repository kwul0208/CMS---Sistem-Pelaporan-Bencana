    ...
    <script>
        $(document).ready(function () {
            $('#tanggap_darurat_bencana-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('report.tanggap-darurat-bencana.data') }}',
                    data: function (d) {
            ...
            $('#filter').on('click', function () {
                $('#tanggap_darurat_bencana-table').DataTable().ajax.reload();
            });
            ...
            $('#export-btn').on('click', function(e) {
                ...
                let url = '{{ route("report.tanggap-darurat-bencana.export") }}' + '?start_date=' + start + '&end_date=' + end;
